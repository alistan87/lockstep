...
class Workspace(Protocol):
    ...
    # `current` lets a caller that needs BOTH answers about the same tree take
    # one snapshot instead of two — each of these otherwise snapshots
    # internally, and a whole-tree snapshot is the expensive operation here
    # (P1-perf). Omit it and the behaviour is unchanged.

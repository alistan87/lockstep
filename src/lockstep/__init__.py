...
docs/spec/AMENDMENTS-r4.md, docs/spec/AMENDMENTS-r5.md, docs/spec/AMENDMENTS-r6.md, and docs/spec/AMENDMENTS-r7.md
(the later revision wins).
"""

__version__ = "0.19.0"  # pinned to pyproject [project].version by test_r7_fixes
